...
The homepage Journey, Ecosystem and Spotlight views are generated by `source/business_explorer.py`, with styles and interactions in `source/business-explorer.css` and `source/business-explorer.js`. Campaigns and professional work lead each view; independent studies appear under Supporting analysis. Run `python source/business_explorer.py` to update just this section and its assets without rebuilding other pages.
