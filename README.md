...
The homepage business-context selector is generated by `source/business_explorer.py`, with styles and interactions in `source/business-explorer.css` and `source/business-explorer.js`. B2B/SaaS, ecommerce and education each explain a distinct buying situation, its marketing implications and one professional example. The former Ecosystem/Spotlight/Journey modes have been consolidated. Run `python source/business_explorer.py` to update just this section and its assets without rebuilding other pages.
