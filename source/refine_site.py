...
featured.append(fragment('<p class="all-work-link"><a class="button secondary" href="/work/">Browse all 13 projects</a></p>'))
...
print('Refined homepage, all-work library and 13 case summaries')
